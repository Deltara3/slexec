...
pub mod unix {
    ...
    unsafe extern "C" {
        ...
        pub unsafe fn dlopen(library_filename: *const c_char, flags: c_int) -> *mut c_void;

        /// Retrieves the address of an exported symbol in a library.
        pub unsafe fn dlsym(library_module: *mut c_void, symbol_name: *const c_char)
        -> *mut c_void;
